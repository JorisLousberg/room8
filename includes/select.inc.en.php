...
<script>
    ...
    function alert_sn(){
        ...
        alert("Your order with " + Studentnumber + " will be ready in 15 minutes");
    ...
    function addtobasket(product_id,product,price) {                                             // values from database
        ...
        ticket = ticket + 'Studentnumber: <input type="text" autocomplete="off" name="fname" id="studentennummer"><input type="submit" onclick="window.parent.alert_sn();" value="Submit">';
